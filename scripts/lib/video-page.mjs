...
export function renderVideoPage(spec) {
  ...
  return [
    ...
    `<body><div id="root" data-style="${esc(spec.style.key)}" data-composition-id="${esc(spec.meta.compositionId)}" data-start="0" data-duration="${spec.meta.duration}" data-width="${spec.meta.width}" data-height="${spec.meta.height}">`,
    scenes,
